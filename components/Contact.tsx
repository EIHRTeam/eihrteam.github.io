        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-16">
          ...
          <GlitchElement delay={0.2}>
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: Tv, label: "BILIBILI", color: "hover:bg-pink-400" },
                { icon: BookHeart, label: "小红书", color: "hover:bg-red-500" },
                { icon: SklandIcon, label: "森空岛", color: "hover:bg-cyan-500" },
                { icon: Github, label: "GITHUB", color: "hover:bg-gray-800" },
              ].map((social, i) => (
                <a key={i} href="#" className={`flex flex-col items-center justify-center p-6 bg-white/10 hover:bg-white hover:text-black border border-white/20 transition-all duration-300 rounded-xl group`}>
